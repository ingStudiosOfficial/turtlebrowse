				...
				if (event instanceof KeyEvent) {
					...
					if (keyEvent.getID() == KeyEvent.KEY_PRESSED) {
						...
						if (keyCode == KeyEvent.VK_I && ctrlPressed && shiftPressed) { // DevTools
							...
							parent.openHistory();
						} else if (keyCode == KeyEvent.VK_F && ctrlPressed) { // Toggles find
							keyEvent.consume();
						...
						} else if (keyCode == KeyEvent.VK_B && ctrlPressed) { // Toggles AI chat
							keyEvent.consume();
						...
						} else if (keyCode == KeyEvent.VK_M && ctrlPressed) { // Toggles more sidebar
							keyEvent.consume();
